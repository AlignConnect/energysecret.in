...
const Formdata = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "energysecret.in/HTM");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HTM ?? "energysecret.in/htm");
            ...
            try {
                setLoading(true)
                const form = await fetch(`https://energysecret.in/submitdata.php`, { body: formdata, method: "POST" })
    ...
    return (<div className="bg-[#FFD3B6] p-2" id="form">
        ...
        <div className={`pb-4 text-black ${poppin.className}`} id='formcallhide'>
            <div className="max-w-2xl md:mx-auto  bg-[#FCF8F3] p-3 border border-black rounded-xl">
                <div className="py-4">
                        ...
                        {CustomerDataValue?.map((data, key) => {
                            return <div className="flex flex-col" key={key}>
                                ...
                                <div className="relative">
                                    <input {...data.inputValue} className={`fontArya py-3 px-3 border border-solid border-black w-full rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 ${data.icon ? 'pl-[3.5rem]' : ''}`} onChange={handleChange} value={CustomerData[data.inputValue.name]} />
