...
const Form = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      formdata.append("post", "energysecret.in/hds");
      formdata.append("ip", check ? check : "");
      formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);

      formdata.append("blog_url", process.env.NEXT_APP_URL_HDS ?? "energysecret.in/hds");
      ...
      if (adsKeeper) {
        await fetch(`https://a.adskeeper.co.uk/postback?c=${adsKeeper}&e=hfts&r={payout}`, {
          method: "GET",
          mode: "no-cors",
        });
      }
